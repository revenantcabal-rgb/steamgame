...
function BanScreen({ expiryDate }: { expiryDate: number }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
      <div className="text-center max-w-md p-8 rounded-lg" style={{ backgroundColor: 'var(--color-bg-secondary)', border: '2px solid #ef4444' }}>
        <h1 className="text-3xl font-bold mb-4" style={{ color: '#ef4444' }}>ACCOUNT SUSPENDED</h1>
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
        <div className="text-center">
          <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--color-accent)' }}>WASTELAND GRIND</h1>
