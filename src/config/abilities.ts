...
export const ABILITIES: Record<string, AbilityTome> = {
  ...
  // =====================================================================
  r_crushing_blow: { id: 'r_crushing_blow', name: 'Crushing Blow', color: 'red', cooldown: 8, isPassive: false, isDecree: false,
    ...
    spCost: 15, duration: 0, mechanicalEffect: { type: 'damage', value: 30, isPercentage: true, scaling: 1 } },

  r_rending_slash: { id: 'r_rending_slash', name: 'Rending Slash', color: 'red', cooldown: 10, isPassive: false, isDecree: false,
  ...
  r_double_strike: { id: 'r_double_strike', name: 'Double Strike', color: 'red', cooldown: 14, isPassive: false, isDecree: false,
  ...
  r_battle_cry: { id: 'r_battle_cry', name: 'Battle Cry', color: 'red', cooldown: 18, isPassive: false, isDecree: false,
  ...
  r_whirlwind_strike: { id: 'r_whirlwind_strike', name: 'Whirlwind Strike', color: 'red', cooldown: 16, isPassive: false, isDecree: false,
  ...
  r_execution: { id: 'r_execution', name: 'Execution', color: 'red', cooldown: 20, isPassive: false, isDecree: false,
  ...
  r_iron_fortress: { id: 'r_iron_fortress', name: 'Iron Fortress', color: 'red', cooldown: 18, isPassive: false, isDecree: false,
  ...
  r_berserker_rush: { id: 'r_berserker_rush', name: 'Berserker Rush', color: 'red', cooldown: 16, isPassive: false, isDecree: false,
  ...
  r_titan_strike: { id: 'r_titan_strike', name: 'Titan Strike', color: 'red', cooldown: 12, isPassive: false, isDecree: false,
  ...
  r_blood_fury: { id: 'r_blood_fury', name: 'Blood Fury', color: 'red', cooldown: 20, isPassive: false, isDecree: false,
  ...
  // =====================================================================
  g_quick_shot: { id: 'g_quick_shot', name: 'Quick Shot', color: 'green', cooldown: 8, isPassive: false, isDecree: false,
  ...
  g_aimed_shot: { id: 'g_aimed_shot', name: 'Aimed Shot', color: 'green', cooldown: 9, isPassive: false, isDecree: false,
  ...
  g_double_tap: { id: 'g_double_tap', name: 'Double Tap', color: 'green', cooldown: 14, isPassive: false, isDecree: false,
  ...
  g_crippling_shot: { id: 'g_crippling_shot', name: 'Crippling Shot', color: 'green', cooldown: 12, isPassive: false, isDecree: false,
  ...
  g_piercing_arrow: { id: 'g_piercing_arrow', name: 'Piercing Arrow', color: 'green', cooldown: 10, isPassive: false, isDecree: false,
  ...
  g_triple_strafe: { id: 'g_triple_strafe', name: 'Triple Strafe', color: 'green', cooldown: 15, isPassive: false, isDecree: false,
  ...
  g_headshot: { id: 'g_headshot', name: 'Headshot', color: 'green', cooldown: 12, isPassive: false, isDecree: false,
  ...
  g_smoke_retreat: { id: 'g_smoke_retreat', name: 'Smoke Retreat', color: 'green', cooldown: 16, isPassive: false, isDecree: false,
  ...
  g_barrage: { id: 'g_barrage', name: 'Barrage', color: 'green', cooldown: 18, isPassive: false, isDecree: false,
  ...
  g_snipers_mark: { id: 'g_snipers_mark', name: "Sniper's Mark", color: 'green', cooldown: 18, isPassive: false, isDecree: false,
  ...
  g_kill_confirm: { id: 'g_kill_confirm', name: 'Kill Confirm', color: 'green', cooldown: 20, isPassive: false, isDecree: false,
  ...
  g_ghost_walk: { id: 'g_ghost_walk', name: 'Ghost Walk', color: 'green', cooldown: 20, isPassive: false, isDecree: false,
  ...
  // =====================================================================
  b_firebomb: { id: 'b_firebomb', name: 'Firebomb', color: 'blue', cooldown: 8, isPassive: false, isDecree: false,
  ...
  b_frag_toss: { id: 'b_frag_toss', name: 'Frag Toss', color: 'blue', cooldown: 9, isPassive: false, isDecree: false,
  ...
  b_concussion_grenade: { id: 'b_concussion_grenade', name: 'Concussion Grenade', color: 'blue', cooldown: 10, isPassive: false, isDecree: false,
  ...
  b_smoke_bomb: { id: 'b_smoke_bomb', name: 'Smoke Bomb', color: 'blue', cooldown: 14, isPassive: false, isDecree: false,
  ...
  b_trip_mine: { id: 'b_trip_mine', name: 'Trip Mine', color: 'blue', cooldown: 10, isPassive: false, isDecree: false,
  ...
  b_napalm_flask: { id: 'b_napalm_flask', name: 'Napalm Flask', color: 'blue', cooldown: 14, isPassive: false, isDecree: false,
  ...
  b_cluster_bomb: { id: 'b_cluster_bomb', name: 'Cluster Bomb', color: 'blue', cooldown: 16, isPassive: false, isDecree: false,
  ...
  b_emp_blast: { id: 'b_emp_blast', name: 'EMP Blast', color: 'blue', cooldown: 16, isPassive: false, isDecree: false,
  ...
  b_toxic_cloud: { id: 'b_toxic_cloud', name: 'Toxic Cloud', color: 'blue', cooldown: 15, isPassive: false, isDecree: false,
  ...
  b_plasma_lance: { id: 'b_plasma_lance', name: 'Plasma Lance', color: 'blue', cooldown: 12, isPassive: false, isDecree: false,
  ...
  b_radiation_burst: { id: 'b_radiation_burst', name: 'Radiation Burst', color: 'blue', cooldown: 18, isPassive: false, isDecree: false,
  ...
  // =====================================================================
  w_first_aid: { id: 'w_first_aid', name: 'First Aid', color: 'white', cooldown: 10, isPassive: false, isDecree: false,
  ...
  w_mending_salve: { id: 'w_mending_salve', name: 'Mending Salve', color: 'white', cooldown: 12, isPassive: false, isDecree: false,
  ...
  w_rally_cry: { id: 'w_rally_cry', name: 'Rally Cry', color: 'white', cooldown: 18, isPassive: false, isDecree: false,
  ...
  w_suppressive_smoke: { id: 'w_suppressive_smoke', name: 'Suppressive Smoke', color: 'white', cooldown: 14, isPassive: false, isDecree: false,
  ...
  w_fortify: { id: 'w_fortify', name: 'Fortify', color: 'white', cooldown: 18, isPassive: false, isDecree: false,
  ...
  w_adrenaline_shot: { id: 'w_adrenaline_shot', name: 'Adrenaline Shot', color: 'white', cooldown: 20, isPassive: false, isDecree: false,
  ...
  w_triage: { id: 'w_triage', name: 'Triage', color: 'white', cooldown: 14, isPassive: false, isDecree: false,
  ...
  w_iron_guard: { id: 'w_iron_guard', name: 'Iron Guard', color: 'white', cooldown: 18, isPassive: false, isDecree: false,
  ...
  w_purifying_light: { id: 'w_purifying_light', name: 'Purifying Light', color: 'white', cooldown: 16, isPassive: false, isDecree: false,
  ...
  w_battlefield_command: { id: 'w_battlefield_command', name: 'Battlefield Command', color: 'white', cooldown: 22, isPassive: false, isDecree: false,
  ...
  w_shield_wall: { id: 'w_shield_wall', name: 'Shield Wall', color: 'white', cooldown: 22, isPassive: false, isDecree: false,
