  ...
  // ──────────────────────────────────────────────
  {
    ...
    parts: [
      ...
      },
      {
        ...
        description: 'Craft a Sharpened Pipe at the weaponsmithing station.',
        flavor: 'Bare hands won\'t cut it against mutants. Fashion something sharp from the scrap.',
        objective: { type: 'craft', target: 'sharpened_pipe', count: 1, description: 'Craft a Sharpened Pipe' },
        rewards: [{ type: 'wc', quantity: 100 }],
        hint: 'Open the Weaponsmithing production skill and craft a Sharpened Pipe.',
      },
      {
        id: 's1_p3',
        title: 'Gear Up',
        description: 'Equip a weapon on your hero.',
        flavor: 'A weapon is useless hanging on the wall. Put it to use.',
        objective: { type: 'equip', target: 'any', count: 1, description: 'Equip a weapon on your hero' },
