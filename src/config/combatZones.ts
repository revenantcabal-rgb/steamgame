...
export const ZONE_TIER_MULTIPLIERS = [
  ...
  { tier: 2, name: 'Hard',       hpMult: 1.5, dmgMult: 1.3, xpMult: 1.5 },
  { tier: 3, name: 'Elite',      hpMult: 2.2, dmgMult: 1.7, xpMult: 2.2 },
  { tier: 4, name: 'Nightmare',  hpMult: 3.0, dmgMult: 2.2, xpMult: 3.0 },
  { tier: 5, name: 'Apocalypse', hpMult: 4.5, dmgMult: 3.0, xpMult: 4.5 },
  { tier: 6, name: 'Extinction', hpMult: 7.0, dmgMult: 4.0, xpMult: 7.0 },
];
  ...
  outskirts: {
    ...
    targets: [
      { id: 'marshland', name: 'Marshland', description: 'Hunt mutated mosquitoes.', isSweep: false,
        enemy: { id: 'mosquito', name: 'Mutated Mosquito', hp: 20, damage: 3, xpReward: 15, resourceDrops: [{ resourceId: 'mutant_roots', chance: 0.3, minQty: 1, maxQty: 2 }] }},
      { id: 'bog', name: 'Bog', description: 'Hunt mutated frogs.', isSweep: false,
        enemy: { id: 'frog', name: 'Mutated Frog', hp: 30, damage: 5, xpReward: 18, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.2, minQty: 1, maxQty: 1 }] }},
      { id: 'burrows', name: 'Burrows', description: 'Hunt mutated centipedes.', isSweep: false,
        enemy: { id: 'centipede', name: 'Mutated Centipede', hp: 25, damage: 7, xpReward: 20, resourceDrops: [{ resourceId: 'scrap_metal', chance: 0.25, minQty: 1, maxQty: 2 }] }},
      { id: 'outskirts_sweep', name: 'Full Sweep', description: 'Clear everything. Boss every 10 kills.', isSweep: true,
        enemy: { id: 'outskirts_mix', name: 'Wasteland Vermin', hp: 25, damage: 5, xpReward: 17, resourceDrops: [{ resourceId: 'mutant_roots', chance: 0.2, minQty: 1, maxQty: 1 }, { resourceId: 'scrap_metal', chance: 0.2, minQty: 1, maxQty: 1 }] }},
    ],
    boss: { id: 'giant_roach', name: 'Giant Roach', hp: 90, damage: 15, xpReward: 100, resourceDrops: [{ resourceId: 'scrap_metal', chance: 1, minQty: 5, maxQty: 10 }, { resourceId: 'chemical_fluids', chance: 0.5, minQty: 2, maxQty: 5 }] },
  ...
  suburbs: {
    ...
    targets: [
      { id: 'alleys', name: 'Alleys', description: 'Hunt feral dog packs.', isSweep: false,
        enemy: { id: 'feral_dog', name: 'Feral Dog Pack', hp: 60, damage: 12, xpReward: 35, resourceDrops: [{ resourceId: 'mutant_roots', chance: 0.3, minQty: 1, maxQty: 3 }] }},
      { id: 'rooftops', name: 'Rooftops', description: 'Hunt mutant hawks.', isSweep: false,
        enemy: { id: 'mutant_hawk', name: 'Mutant Hawk', hp: 45, damage: 18, xpReward: 40, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.3, minQty: 1, maxQty: 2 }] }},
      { id: 'basements', name: 'Basements', description: 'Hunt rad rat swarms.', isSweep: false,
        enemy: { id: 'rad_rats', name: 'Rad Rat Swarm', hp: 80, damage: 10, xpReward: 38, resourceDrops: [{ resourceId: 'scrap_metal', chance: 0.3, minQty: 2, maxQty: 4 }] }},
      { id: 'suburbs_sweep', name: 'Full Sweep', description: 'Clear everything. Boss every 10 kills.', isSweep: true,
        enemy: { id: 'suburbs_mix', name: 'Suburb Dweller', hp: 60, damage: 13, xpReward: 37, resourceDrops: [{ resourceId: 'iron_ore', chance: 0.2, minQty: 1, maxQty: 2 }, { resourceId: 'scrap_metal', chance: 0.2, minQty: 1, maxQty: 2 }] }},
    ],
    boss: { id: 'alpha_wolf', name: 'Alpha Wolf', hp: 250, damage: 30, xpReward: 250, resourceDrops: [{ resourceId: 'iron_ore', chance: 1, minQty: 8, maxQty: 15 }, { resourceId: 'mechanical_parts', chance: 0.5, minQty: 3, maxQty: 8 }] },
  ...
  industrial: {
    ...
    targets: [
      { id: 'chemical_vats', name: 'Chemical Vats', description: 'Hunt slime crawlers.', isSweep: false,
        enemy: { id: 'slime_crawler', name: 'Slime Crawler', hp: 120, damage: 22, xpReward: 65, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.4, minQty: 2, maxQty: 4 }] }},
      { id: 'assembly_line', name: 'Assembly Line', description: 'Fight rogue drones.', isSweep: false,
        enemy: { id: 'rogue_drone', name: 'Rogue Drone', hp: 100, damage: 30, xpReward: 70, resourceDrops: [{ resourceId: 'electronic_components', chance: 0.4, minQty: 2, maxQty: 4 }] }},
      { id: 'waste_tunnels', name: 'Waste Tunnels', description: 'Hunt sewer beasts.', isSweep: false,
        enemy: { id: 'sewer_beast', name: 'Sewer Beast', hp: 150, damage: 25, xpReward: 75, resourceDrops: [{ resourceId: 'mechanical_parts', chance: 0.4, minQty: 2, maxQty: 4 }] }},
      { id: 'industrial_sweep', name: 'Full Sweep', description: 'Clear everything. Boss every 10 kills.', isSweep: true,
        enemy: { id: 'industrial_mix', name: 'Factory Mutant', hp: 120, damage: 25, xpReward: 70, resourceDrops: [{ resourceId: 'electronic_components', chance: 0.2, minQty: 1, maxQty: 2 }, { resourceId: 'chemical_fluids', chance: 0.2, minQty: 1, maxQty: 2 }] }},
    ],
    boss: { id: 'factory_overseer', name: 'Factory Overseer', hp: 500, damage: 50, xpReward: 500, resourceDrops: [{ resourceId: 'electronic_components', chance: 1, minQty: 10, maxQty: 20 }, { resourceId: 'mechanical_parts', chance: 1, minQty: 8, maxQty: 15 }] },
  ...
  deadlands: {
    ...
    targets: [
      { id: 'sand_dunes', name: 'Sand Dunes', description: 'Hunt sandworms.', isSweep: false,
        enemy: { id: 'sandworm', name: 'Sandworm', hp: 200, damage: 35, xpReward: 100, resourceDrops: [{ resourceId: 'raw_stone', chance: 0.4, minQty: 3, maxQty: 6 }] }},
      { id: 'raider_camps', name: 'Raider Camps', description: 'Fight raider gangs.', isSweep: false,
        enemy: { id: 'raider_gang', name: 'Raider Gang', hp: 180, damage: 40, xpReward: 120, resourceDrops: [{ resourceId: 'scrap_metal', chance: 0.4, minQty: 3, maxQty: 6 }] }},
      { id: 'radiation_craters', name: 'Radiation Craters', description: 'Hunt glowing ghouls.', isSweep: false,
        enemy: { id: 'glowing_ghoul', name: 'Glowing Ghoul', hp: 180, damage: 45, xpReward: 110, resourceDrops: [{ resourceId: 'copper_ore', chance: 0.4, minQty: 3, maxQty: 6 }] }},
  ...
  military: {
    ...
    targets: [
      { id: 'perimeter', name: 'Perimeter', description: 'Fight turret arrays.', isSweep: false,
        enemy: { id: 'turret_array', name: 'Turret Array', hp: 300, damage: 50, xpReward: 160, resourceDrops: [{ resourceId: 'electronic_components', chance: 0.5, minQty: 3, maxQty: 6 }] }},
      { id: 'barracks', name: 'Barracks', description: 'Fight bio-soldiers.', isSweep: false,
        enemy: { id: 'bio_soldier', name: 'Bio-Soldier', hp: 280, damage: 60, xpReward: 180, resourceDrops: [{ resourceId: 'mechanical_parts', chance: 0.5, minQty: 3, maxQty: 6 }] }},
      { id: 'research_lab', name: 'Research Lab', description: 'Fight escaped experiments.', isSweep: false,
        enemy: { id: 'experiment', name: 'Escaped Experiment', hp: 400, damage: 80, xpReward: 200, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.5, minQty: 4, maxQty: 8 }] }},
  ...
  the_core: {
    ...
    targets: [
      { id: 'outer_ring', name: 'Outer Ring', description: 'Fight radiation elementals.', isSweep: false,
        enemy: { id: 'rad_elemental', name: 'Radiation Elemental', hp: 500, damage: 100, xpReward: 300, resourceDrops: [{ resourceId: 'copper_ore', chance: 0.5, minQty: 5, maxQty: 10 }] }},
      { id: 'inner_chamber', name: 'Inner Chamber', description: 'Fight mutant abominations.', isSweep: false,
        enemy: { id: 'abomination', name: 'Mutant Abomination', hp: 600, damage: 130, xpReward: 350, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.5, minQty: 5, maxQty: 10 }] }},
      { id: 'reactor_room', name: 'Reactor Room', description: 'Fight fusion golems.', isSweep: false,
        enemy: { id: 'fusion_golem', name: 'Fusion Golem', hp: 700, damage: 150, xpReward: 400, resourceDrops: [{ resourceId: 'electronic_components', chance: 0.5, minQty: 5, maxQty: 10 }] }},
  ...
  ground_zero: {
    ...
    targets: [
      { id: 'crater_edge', name: 'Crater Edge', description: 'Fight phase walkers.', isSweep: false,
        enemy: { id: 'phase_walker', name: 'Phase Walker', hp: 800, damage: 180, xpReward: 500, resourceDrops: [{ resourceId: 'iron_ore', chance: 0.5, minQty: 8, maxQty: 15 }] }},
      { id: 'anomaly_field', name: 'Anomaly Field', description: 'Fight reality breakers.', isSweep: false,
        enemy: { id: 'reality_breaker', name: 'Reality Breaker', hp: 1000, damage: 200, xpReward: 600, resourceDrops: [{ resourceId: 'electronic_components', chance: 0.5, minQty: 8, maxQty: 15 }] }},
      { id: 'epicenter', name: 'Epicenter', description: 'Fight apocalypse heralds.', isSweep: false,
        enemy: { id: 'apocalypse_herald', name: 'Apocalypse Herald', hp: 1200, damage: 250, xpReward: 700, resourceDrops: [{ resourceId: 'chemical_fluids', chance: 0.5, minQty: 8, maxQty: 15 }] }},
